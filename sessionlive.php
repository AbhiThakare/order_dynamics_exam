...
<?php 
	...
	echo "<B>Username :</B> ".$username."<BR>"."<B>Semester :</B> ".$semester."<BR>"."<B>Session Status :</B> Alive";

echo "<BR>";
echo "<B>Session Logout :</B>";
echo " <A HREF='sessiondestroy.php?username=$username&semester=$semester'>Logout</A>"; 
?>
</DIV>
</BODY>
</HTML>
