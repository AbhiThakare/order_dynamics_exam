...
<table id="Table_01" width="1025" height="769" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		...
		<?php  //$subjects = "C";
			...
			echo "Hello <b>".$_REQUEST['username'].", </b>";
			...
			$query = "SELECT * FROM session WHERE username='".$_REQUEST['username']."'";
			$result = mysql_query($query);
			$row=mysql_fetch_array($result);
		?>
			<a href="examlist.php?username=<?php echo $row['username']?>&semester=<?php echo $row['semester']?>">START</a>
		</DIV></td>
		<td>
